...
// Create a to-do item
app.post('/todos', passport.authenticate("jwt", { session: false }), async (req, res, next) => {
...
// Update a to-do item
app.put('/todos/:id', passport.authenticate("jwt", { session: false }), async (req, res, next) => {
    // if authentication is unsuccessful, the response is 401 Unauthorized
...
// Delete a to-do item
app.delete('/todos/:id', passport.authenticate("jwt", { session: false }), async (req, res, next) => {
    // if authentication is unsuccessful, the response is 401 Unauthorized
...
// Get to-do items
app.get('/todos', passport.authenticate("jwt", { session: false }), async (req, res, next) => {
    // if authentication is unsuccessful, the response is 401 Unauthorized
